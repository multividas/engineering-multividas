...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'With engineering.multividas.com, you can write and publish technical articles.' }],
    ...
    ['meta', { property: 'og:site_name', content: 'Multividas Engineering blog' }],
    // multividas tags
    ['meta', { property: 'multividas:card', description: 'summary' }],
    ['meta', { property: 'multividas:site', description: 'multividaseng' }],
    ['meta', { property: 'multividas:title', description: 'Multividas Engineering blog' }],
    ['meta', { property: 'multividas:description', description: 'With engineering.multividas.com, you can write and publish technical articles.' }],
